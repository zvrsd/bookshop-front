...
public class AuthorDAO implements DAO<Author, Integer> {
    ...
    @Override
    public void add(Author object) throws NamingException, SQLException {
    ...
    @Override
    public void update(Author object) throws SQLException, NamingException {
    ...
    @Override
    public void delete(Author object) throws NamingException, SQLException {
        ...
        statement = connection.prepareStatement(QUERY_DELETE_AUTHOR);
