    ...
    <body>
        ...
        <div id="font">
            ...
            <div id="containerLiv">
                ...
                <div id="liv4"><form method="get" action="adresse"><button class="bttn-unite" type="submit" name="action" value="livraison"><h3>Ajouter adresse de livraison</h3></button></form></div> 
            </div>
            ...
            <div id="containerFac">
                ...
                <div id="fac4"><form method="get" action="adresse"><button class="bttn-unite" type="submit" name="action" value="facturation"><h3>Ajouter adresse de facturation</h3></button></form></div> 
            </div>
