...
<html>
    ...
    <body>
        ...
        <div id="containerLiv">
            ...
            <div id="liv4"><form method="get" action="adresse"><button class="button" type="submit"><h3>Ajouter adresse de livraison</h3></button></form></div> 
        </div>
        ...
        <div id="containerFac">
            ...
            <div id="fac4"><form method="get" action="adresse"><button class="button" type="submit"><h3>Ajouter adresse de facturation</h3></button></form></div> 
        </div>
    </body>
</html>
