/*==============================================================*/
/* Nom: dernier jeu essay de LOIC pour BookShop                 */
/* Date de cr�ation :  30/09/2020 16:52:00                      */
/*==============================================================*/
...
-- RESET AUTO-INCREMENT PKs
DBCC CHECKIDENT('EVENT', RESEED, 0)
DBCC CHECKIDENT('AUTHOR', RESEED, 0)
DBCC CHECKIDENT('PUBLISHER', RESEED, 0)
DBCC CHECKIDENT('BOOK_STATUS', RESEED, 0)
DBCC CHECKIDENT('COMMENT_STATUS', RESEED, 0)
DBCC CHECKIDENT('PACKAGE_STATUS', RESEED, 0)
DBCC CHECKIDENT('PAYMENT_STATUS', RESEED, 0)
DBCC CHECKIDENT('CARRIER_STATUS', RESEED, 0)
DBCC CHECKIDENT('KEYWORD', RESEED, 0)
...
DBCC CHECKIDENT('PAYMENT_ORGANIZATION', RESEED, 0)
...
/* Littérature */
('9782072878497', 1, 3, '1984', '', 8.5, 'http://url-cover.com/0.pngurl-cover.com/0.png', 'Le roman contre-utopique du XXe siècle', 14, 'rayon A', ''),
('9782710381419', 1, 3, 'Antigone', '', 6.1, 'http://url-cover.com/0.png', 'Adaptation du célèbre personnage de la mythologie au contexte du XXe siècle', 58, 'rayon A', ''),
('9782070375165', 1, 3, 'La ferme des animaux', '', 6.3, 'http://url-cover.com/0.png', '', 2, 'rayon L', ''),
('9782253010043', 2, 3, 'Les fables de La Fontaine', '', 3.1, 'http://url-cover.com/0.png', '', 30, 'rayon L', ''),
('9782081516342', 3, 3, 'Les fausses confidences', '', 2.8, 'http://url-cover.com/0.png', '', 5, 'rayon L', ''),
('9782070320530', 4, 3, 'Fêtes Galantes', '', 6.2, 'http://url-cover.com/0.png', '', 56, 'rayon L', ''),
('9782253161080', 2, 3, 'La confession d''un enfant du siècle', '', 6.5, 'http://url-cover.com/0.png', '', 12, 'rayon L', ''),
('9782010008993', 2, 3, 'Les Misérables', '', 4.75, 'http://url-cover.com/0.png', 'Le plus fameux roman de Victor Hugo, qui nous plonge dans les misères du peuple parisien dans les décennies suivant la Révolution.', 84, 'rayon L', ''),
('9782070406029', 4, 3, 'Les Châtiments', '', 7.5, 'http://url-cover.com/0.png', 'Le recueil de poèmes de Victor Hugo, opposant politique féroce à Napoléon III.', 2, 'rayon L', ''),
('9782253160786', 2, 3, 'Quatrevingt-Treize', '', 5.7, 'http://url-cover.com/0.png', '', 26, 'rayon Q', ''),
('9782020222129', 5, 3, 'Don Quichotte de la Manche', '', 8.8, 'http://url-cover.com/0.png', '', 51, 'rayon D', ''),
('9782080712165', 3, 3, 'Divine Comédie', 'L''Enfer', 10.00, 'http://url-cover.com/0.png', '', 3, 'Rayon D', ''),

/* Sciences humaines */
('9782070400683', 1, 3, 'La Guerre du Péloponnèse', '', 13.5, 'http://url-cover.com/0.png', '', 18, 'Rayon L', ''),
('9782070387625', 1, 3, 'Annales', '', 9.9, 'http://url-cover.com/0.png', '', 3, 'rayon A', ''),
('9782757802137', 5, 3, 'L''interprétation du rêve', '', 13.5, 'http://url-cover.com/0.png', '', 2, 'Rayon L', ''),
('9782081358775', 3, 3, 'Politiques', '', 10.0, 'http://url-cover.com/0.png', '', 5, 'Rayon P', ''),
('9782080705631', 3, 3, 'Métaphysique', '', 11.5, 'http://url-cover.com/0.png', '', 2, 'Rayon M', ''),
('9782081421547', 3, 3, 'De l''Âme', '', 8.1, 'http://url-cover.com/0.png', '', 2, 'Rayon M', ''),
('9782081386693', 3, 3, 'République', '', 8.9, 'http://url-cover.com/0.png', '', 8, 'Rayon R', ''),
('9782081427730', 3, 3, 'Gorgias', '', 5.2, 'http://url-cover.com/0.png', '', 8, 'Rayon G', ''),
('9782080704894', 3, 3, 'Phédon', '', 8.2, 'http://url-cover.com/0.png', '', 4, 'Rayon P', ''),
('9782081377226', 3, 3, 'Apologie de Socrate', '', 3.5, 'http://url-cover.com/0.png', '', 7, 'Rayon A', ''),
('9782081422582', 3, 3, 'Banquet', '', 4.0, 'http://url-cover.com/0.png', '', 27, 'Rayon B', ''),
('9782080706881', 3, 3, 'Parménide', '', 8.8, 'http://url-cover.com/0.png', '', 4, 'Rayon P', ''),

/* BD / Manga */
('9782876952058', 6, 3, 'Dragon Ball', 'Tome 1', 6.9, 'http://url-cover.com/0.png', '', 2, 'rayon D', ''),
('9782876952065', 6, 3, 'Dragon Ball', 'Tome 2', 6.9, 'http://url-cover.com/0.png', '', 1, 'rayon D', ''),
('9782876952072', 6, 3, 'Dragon Ball', 'Tome 3', 6.9, 'http://url-cover.com/0.png', '', 8, 'rayon D', ''),
('9782876952102', 6, 3, 'Dragon Ball', 'Tome 4', 6.9, 'http://url-cover.com/0.png', '', 1, 'rayon D', ''),
('9782876952119', 6, 3, 'Dragon Ball', 'Tome 5', 6.9, 'http://url-cover.com/0.png', '', 11, 'rayon D', ''),
('9782876952126', 6, 3, 'Dragon Ball', 'Tome 6', 6.9, 'http://url-cover.com/0.png', '', 1, 'rayon D', ''),
('9782876952171', 6, 3, 'Dragon Ball', 'Tome 7', 6.9, 'http://url-cover.com/0.png', '', 1, 'rayon D', ''),
('9782876952188', 6, 3, 'Dragon Ball', 'Tome 8', 6.9, 'http://url-cover.com/0.png', '', 14, 'rayon D', ''),
('9782876952195', 6, 3, 'Dragon Ball', 'Tome 9', 6.9, 'http://url-cover.com/0.png', '', 1, 'rayon D', ''),
('9782876952201', 6, 3, 'Dragon Ball', 'Tome 10', 6.9, 'http://url-cover.com/0.png', '', 1, 'rayon D', ''),
('9782876952218', 6, 3, 'Dragon Ball', 'Tome 11', 6.9, 'http://url-cover.com/0.png', '', 31, 'rayon D', ''),
('9782723418553', 6, 3, 'Dragon Ball', 'Tome 12', 6.9, 'http://url-cover.com/0.png', '', 1, 'rayon D', ''),
('9782723418560', 6, 3, 'Dragon Ball', 'Tome 13', 6.9, 'http://url-cover.com/0.png', '', 7, 'rayon D', ''),
('9782723418577', 6, 3, 'Dragon Ball', 'Tome 14', 6.9, 'http://url-cover.com/0.png', '', 1, 'rayon D', ''),
('9782723418584', 6, 3, 'Dragon Ball', 'Tome 15', 6.9, 'http://url-cover.com/0.png', '', 1, 'rayon D', ''),
('9782203198920', 7, 3, 'Les Aventures de Tintin', 'Intégrale : Coffret en 8 volumes', 90.0, 'http://url-cover.com/0.png', '', 5, 'rayon L', ''),
('9782203001114', 7, 3, 'Les Aventures de Tintin', 'Le Trésor de Rackham le Rouge', 11.5, 'http://url-cover.com/0.png', '', 5, 'rayon L', ''),
('9782203001152', 7, 3, 'Les Aventures de Tintin', 'Objectif Lune', 11.5, 'http://url-cover.com/0.png', '', 5, 'rayon L', ''),
('9782203001169', 7, 3, 'Les Aventures de Tintin', 'On a marché sur la Lune', 11.5, 'http://url-cover.com/0.png', '', 4, 'rayon L', ''),
('9782203001107', 7, 3, 'Les Aventures de Tintin', 'Le Secret de la Licorne', 11.5, 'http://url-cover.com/0.png', '', 2, 'rayon L', ''),
('9782203001121', 7, 3, 'Les Aventures de Tintin', 'Les sept boules de cristal', 11.5, 'http://url-cover.com/0.png', '', 2, 'rayon L', ''),
('9782203001183', 7, 3, 'Les Aventures de Tintin', 'Coke en stock', 11.5, 'http://url-cover.com/0.png', '', 3, 'rayon L', ''),

/* Jeunesse */
('9782075109178', 1, 3, 'Une aventure de Kamo', '1. - L''idée du siècle', 5.9, 'http://url-cover.com/0.png', '', 8, 'Rayon U', ''),
('9782075090858', 1, 3, 'Une aventure de Kamo', '2. - Kamo et moi', 5.9, 'http://url-cover.com/0.png', '', 5, 'Rayon U', ''),
('9782075109222', 1, 3, 'Une aventure de Kamo', '3. - L''agence Babel', 5.9, 'http://url-cover.com/0.png', '', 3, 'Rayon U', ''),
('9782075090841', 1, 3, 'Une aventure de Kamo', '4. - L''évasion de Kamo', 5.9, 'http://url-cover.com/0.png', '', 14, 'Rayon U', ''),
('9782012202894', 8, 3, 'Oui-Oui joue au football', '', 1.75, 'http://url-cover.com/0.png', '', 25, 'Rayon O', ''),
('9782012274495', 8, 3, 'Oui-Oui et la fête de la musique', '', 1.75, 'http://url-cover.com/0.png', '', 25, 'Rayon O', ''),
('9782012275973', 8, 3, 'Oui-Oui et la fête de Miniville', '', 1.75, 'http://url-cover.com/0.png', '', 52, 'Rayon O', ''),

/* Autres */
('9782416000188', 9, 3, 'Programmer en Java', 'Couvre Java 10 à Java 14', 35.00, 'http://url-cover.com/0.png', '', 13, 'Rayon P', ''),
('9782212675214', 9, 3, 'Apprenez à programmer en Java', '', 35.0, 'http://url-cover.com/0.png', '', 54, 'Rayon A', ''),
('9782409026300', 10, 3, 'Apprendre la Programmation Orientée Objet avec le langage Java', '', 28.0, 'http://url-cover.com/0.png', '', 12, 'Rayon A', '')
;
...
insert into PAYMENT_STATUS (PAYMENT_STATUS_NAME,PAYMENT_STATUS_POST_IT) values ('en cours de tra','commentairePaiement 3');
insert into PAYMENT_STATUS (PAYMENT_STATUS_NAME,PAYMENT_STATUS_POST_IT) values ('en attente de val','commentairePaiement 4');
insert into PAYMENT_STATUS (PAYMENT_STATUS_NAME,PAYMENT_STATUS_POST_IT) values ('en cour de ver','commentairePaiement 5');
